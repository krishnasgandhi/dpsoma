	...
	class WPEX_Demo_Importer {
		...
		public function enqueue_admin_scripts( $hook ) {
			...
			wp_localize_script( 'total-theme-demo-importer', 'wpex_js_vars', array(
				...
				'content_importing_error'         => esc_html__( 'There was a problem during the importing process resulting in the following error from your server:', 'total-theme-core' ),
			) );
