...
<div class="wpex-selected-notice">
	...
	<p class="wpex-selected-notice-warning">
		...
		echo sprintf( __( '<strong>Important:</strong> For your site to look exactly like this demo you should install the sample data on a clean installation of WordPress to prevent conflicts with current content (due to how WordPress stores content using ID\'s). You can use this plugin to reset your site if needed: <a href="%s" target="_blank">Wordpress Database Reset</a>. Otherwise, select only the options you require on the next screen.', 'total-theme-core' ), $plugin_link ); ?>
	</p>
		...
		<ul>
			...
			<li>
				<label for="wpex_import_mods">
					...
					<strong><?php esc_html_e( 'Import Theme Customizer Settings', 'total-theme-core' ); ?></strong> (<?php esc_html_e( 'Will reset your current settings', 'total-theme-core' ); ?>)
				</label>
			</li>
