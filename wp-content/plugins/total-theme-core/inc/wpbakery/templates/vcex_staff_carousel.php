				...
				if ( 'true' == $media && has_post_thumbnail() ) {
					...
					$media_output .= '<div class="' . $media_classes . '">';
						...
						elseif ( 'lightbox' == $thumbnail_link ) {
							...
							$media_output .= '<a href="' . vcex_get_lightbox_image() . '" title="' . $atts['post_esc_title'] . '" data-title="' . $atts['post_esc_title'] . '" data-count="' . $lcount . '" class="wpex-carousel-entry-img wpex-carousel-lightbox-item">';
