						...
						$output .= '<div class="wpex-slider-media">';
							...
							if ( $attachment_video ) {
								...
								if ( 'lightbox' == $thumbnail_link ) {
									...
									$output .= '<a href="' . vcex_get_lightbox_image( $attachment ) . '" class="vcex-flexslider-entry-img wpex-slider-media-link wpex-lightbox-group-item"' . $lightbox_data_attributes . '>';
