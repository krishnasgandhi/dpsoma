									...
									if ( 'nowhere' != $thumb_link ) :
										...
										if ( $thumb_link == 'lightbox' ) :
											...
											if ( 'video' == $atts['post_format'] ) :
												...
												$embed_url = vcex_get_video_embed_url( $atts['post_video'] );
											...
											// Image lightbox link
											 ...
											 $media_output .= '<a href="' . esc_url( $atts['post_permalink'] ) . '" title="' . $atts['post_esc_title'] . '"' . $url_target . '>';
						...
						if ( $entry_has_details ) {
							...
							$output .= '>';
								...
								if ( 'true' == $title ) {
									...
									$title_output .= '<' . $title_tag_escaped . ' class="vcex-blog-entry-title entry-title"' . $heading_style . '><a href="' . $atts['post_permalink'] . '"' . $url_target . $heading_link_style . '>' . wp_kses_post( $atts['post_title'] ) . '</a></' . $title_tag_escaped . '>';
