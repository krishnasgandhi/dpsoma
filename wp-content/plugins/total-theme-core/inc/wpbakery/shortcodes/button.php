				...
				'params' => array(
					...
					array(
						...
						'value' => array(
							...
							esc_html__( 'Open image', 'total-theme-core' ) => 'image',
							esc_html__( 'Open lightbox', 'total-theme-core' ) => 'lightbox',
						),
					...
					array(
						'type' => 'vcex_ofswitch',
						'std' => 'false',
						'heading' => esc_html__( 'Include Download Attribute', 'total-theme-core' ),
					...
					array(
						...
						'value' => array(
							esc_html__( 'Auto Detect - slow', 'total-theme-core' ) => '',
							...
							esc_html__( 'Quicktime', 'total-theme-core' ) => 'quicktime',
						),
						'description' => esc_html__( 'Auto detect depends on the iLightbox API, so by choosing your type it speeds things up and you also allows for HTTPS support.', 'total-theme-core' ),
					...
					array(
						'type' => 'textfield',
						'heading' => esc_html__( 'HTML5 Webm URL', 'total-theme-core' ),
						'param_name' => 'lightbox_video_html5_webm',
						'description' => esc_html__( 'Enter the URL to a video, SWF file, flash file or a website URL to open in lightbox.', 'total-theme-core' ),
						'group' => esc_html__( 'Lightbox', 'total-theme-core' ),
						'dependency' => array( 'element' => 'lightbox_type', 'value' => 'html5' ),
					),
					array(
						'type' => 'attach_image',
						'heading' => esc_html__( 'Lightbox HTML5 Poster Image', 'total-theme-core' ),
					...
					array(
						...
						'description' => esc_html__( 'Enter a custom width and height for your lightbox pop-up window. Use format widthxheight. Example: 900x600.', 'total-theme-core' ),
						'group' => esc_html__( 'Lightbox', 'total-theme-core' ),
