	...
	class VCEX_Post_Type_Grid_Shortcode {
		...
		public function vc_after_mapping() {
			...
			if ( is_admin() ) {
				...
				add_filter(
					'vc_autocomplete_vcex_post_type_grid_tax_query_taxonomy_callback',
					'vcex_suggest_taxonomies'
				);
				add_filter(
					'vc_autocomplete_vcex_post_type_grid_filter_taxonomy_callback',
					'vcex_suggest_taxonomies'
				);
				add_filter(
				...
				add_filter(
					'vc_autocomplete_vcex_post_type_grid_categories_taxonomy_callback',
					'vcex_suggest_taxonomies'
				);
				add_filter(
				...
				add_filter(
					'vc_autocomplete_vcex_post_type_grid_filter_taxonomy_render',
					'vcex_render_taxonomies'
				);
				add_filter(
					'vc_autocomplete_vcex_post_type_grid_tax_query_taxonomy_render',
					'vcex_render_taxonomies'
				);
				add_filter(
					'vc_autocomplete_vcex_post_type_grid_categories_taxonomy_render',
					'vcex_render_taxonomies'
				);
				add_filter(
				...
				add_filter(
					'vc_edit_form_fields_attributes_vcex_post_type_grid',
			...
			return array(
				...
				'params' => array(
					...
					array(
						...
						'description' => esc_html__( 'Start typing a post name to locate and add it.', 'total-theme-core' ),
						'dependency' => array( 'element' => 'custom_query', 'value' => array( 'false' ) ),
					),
					array(
						'type' => 'autocomplete',
					...
					array(
						'type' => 'vcex_select_buttons',
						'heading' => esc_html__( 'Filter What?', 'total-theme-core' ),
						'param_name' => 'filter_type',
						'std' => 'post_types',
						'choices' => array(
							'post_types' => esc_html__( 'Post Types', 'total-theme-core' ),
							'taxonomy' => esc_html__( 'Custom Taxonomy', 'total-theme-core' ),
						),
						'group' => esc_html__( 'Filter', 'total-theme-core' ),
						'dependency' => array( 'element' => 'filter', 'value' => 'true' ),
					),
