			...
			return array(
				...
				'params' => array(
					...
					array(
						...
						'description' => esc_html__( 'Enter the "Unique Id" of the post grid module you wish to filter. This will only work on the theme specific grids. Make sure the filter on the grid module is disabled to prevent conflicts. View theme docs for more info.', 'total-theme-core' ),
						'group' => esc_html__( 'Menu', 'total-theme-core' ),
					),
					array(
						'type' => 'vcex_ofswitch',
