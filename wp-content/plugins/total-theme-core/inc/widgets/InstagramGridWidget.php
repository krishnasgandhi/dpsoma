...
class InstagramGridWidget extends WidgetBuilder {
	...
	public function __construct() {
		...
		$this->args = array(
			...
			'name'    => $this->branding() . esc_html__( 'Instagram Grid', 'total-theme-core' ),
			'options' => array(
	...
	if ( ! $instagram ) {
		...
		if ( ! $insta_array ) {
			return new WP_Error( 'bad_json', esc_html__( 'Instagram has returned invalid data.', 'total-theme-core' ) );
		}
