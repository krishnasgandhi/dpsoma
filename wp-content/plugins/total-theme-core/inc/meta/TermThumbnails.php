...
class TermThumbnails {
	...
	public function __construct() {
		...
		$this->placeholder = apply_filters( 'TotalThemeCore\TermThumbnails\placeholder', TTC_PLUGIN_DIR_URL . '/assets/images/term-meta-placeholder.png' );
	...
	public function add_form_fields( $taxonomy ) {
		...
		<div class="form-field">
			...
			<label for="display_type"><?php esc_html_e( 'Page Header Thumbnail', 'total-theme-core' ); ?></label>

			<select id="wpex_term_page_header_image" name="wpex_term_page_header_image" class="postform">
				<option value=""><?php esc_html_e( 'Default', 'total-theme-core' ); ?></option>
				<option value="false"><?php esc_html_e( 'No', 'total-theme-core' ); ?></option>
				<option value="true"><?php esc_html_e( 'Yes', 'total-theme-core' ); ?></option>
			</select>
	...
	public function remove_term_data( $term_id, $key ) {
		...
		delete_term_meta( $term_id, $key, wp_strip_all_tags( $data ) );
