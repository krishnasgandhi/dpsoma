...
class iLightbox {
	...
	public static function skins() {
		return apply_filters( 'wpex_ilightbox_skins', array(
			...
			'flat-dark'   => esc_html__( 'Flat Dark', 'total' ),
	...
	public static function customizer_settings( $sections ) {
		$skins = array( '' => esc_html__( 'Default', 'total' ) );
		...
		$sections['wpex_lightbox'] = array(
			...
			'settings' => array(
				...
				array(
					...
					'default' => false,
					'control' => array(
						'label' => esc_html__( 'Load Skin Globally', 'total' ),
						'type' => 'checkbox',
						'desc' => esc_html__( 'Load the lightbox skin on the entire website. Enable if you are adding custom inline lightbox links via HTML.', 'total' ),
					),
				),
				array(
					'id' => 'lightbox_auto',
				...
				array(
					...
					'default' => true,
					'control' => array(
						'label' => esc_html__( 'Animated Effects', 'total' ),
						'type' => 'checkbox',
					),
				),
				array(
