...
class AdminPanel {
	...
	public function get_addons() {
		$addons = array(
			...
			Under construction....
			't_lazyload' => array(
				'label'    => esc_html__( 'Lazy Load Images & Embeded Videos', 'total' ),
	...
	public function create_admin_page() {
		...
		<div class="wpex-theme-panel wpex-main-panel wpex-clr">
			...
			<div class="wrap about-wrap">
				...
				<p class="about-text"><?php esc_attr_e( 'Here you can enable or disable various core features of the theme in order to keep the site optimized for your needs.', 'total' ); ?></p>
