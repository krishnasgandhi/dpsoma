...
class FooterBuilder {
	...
	public function content_id_field_callback() {
		...
		<img src="<?php echo esc_url( includes_url( 'images/spinner.gif' ) ); ?>" class="wpex-edit-template-links-spinner" width="20" height="20" alt="<?php esc_html( 'Loading...', 'total' ); ?>" />
	...
	public function bg_img_field_callback() {
		...
		<div class="uploader">
			...
			<a href="#" class="wpex-media-remove button-secondary"><span class="dashicons dashicons-no-alt" style="line-height: inherit;"></span></a>
	...
	public function create_admin_page() { ?>
		...
		<div id="wpex-admin-page" class="wrap">
			...
			<p class="wpex-max-width-text">
				<?php echo esc_html__( 'By default the footer consists of a simple widgetized area which you can control via the WordPress Customizer. For more complex layouts you can use the option below to select a template and create your own custom footer layout from scratch.', 'total' ); ?>
	...
	public function edit_links( $template_id = '' ) {
		...
		<a href="<?php echo esc_url( admin_url( 'post.php?post=' . absint( $template_id ) . '&action=edit' ) ); ?>" target="_blank"><?php echo esc_html__( 'Backend Edit', 'total' ); ?></a> 
