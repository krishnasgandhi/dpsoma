...
$this->sections['wpex_woocommerce_archives'] = array(
	...
	'settings' => array(
		...
		array(
			...
			'transport' => 'postMessage',
			'control' => array(
				'label' => esc_html__( 'Entry Equal Heights?', 'total' ),
				'type' => 'checkbox',
				'desc' => esc_html__( 'Enabling this setting will display all the add to cart buttons in the same spot for each entry. Disabled in the Customizer to prevent conflicts.', 'total' ),
			),
		),
		array(
		...
		array(
			...
			'transport' => 'postMessage',
			'control' => array(
				'label' => esc_html__( 'Enable Entry Rating?', 'total' ),
				'type' => 'checkbox',
			),
			'inline_css' => array(
...
$this->sections['wpex_woocommerce_single'] = array(
	...
	'settings' => array(
		...
		array(
			...
			'transport' => 'postMessage',
			'control' => array(
				'label' => esc_html__( 'Post Rating', 'total' ),
				'type' => 'checkbox',
			),
			'inline_css' => array(
		...
		array(
			...
			'default' => false,
			'control' => array(
				'label' => esc_html__( 'Disable Tabs on Mobile?', 'total' ),
				'type' => 'checkbox',
			),
		),
	),
