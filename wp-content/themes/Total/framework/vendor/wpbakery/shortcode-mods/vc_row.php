		...
		public static function modify_params( $params ) {
			...
			$params['vc_row'] = array(
				...
				'gap' => array(
					...
					'description' =>  esc_html__( 'Alters the outer column gap to be used when adding backgrounds to your columns. To increase the default space between the columns without backgrounds use the "Outer Column Gap" setting instead.', 'total' ),
					'weight' => 40,
				),
